...
def process_and_add_to_collector(corpus: str, collector: ChromaCollector, clear_collector_before_adding: bool, metadata: dict):
    ...
    print('len of data_chunks:', len(data_chunks))
    ...
    # print('data_chunks_with_context', data_chunks_with_context)
    # print('data_chunk_starting_indices', data_chunk_starting_indices)
